...
from ..custom_tmp_file import BIOMART_CONTENTS, BIOMART_RESPONSE
...
def test_raises_http_error(tmp_path: Path) -> None:
    ...
    with pytest.raises(HTTPError), requests_mock.Mocker() as m:
        ...
        biomart_request(transcripts, str(tmp_path))
...
def test_writes_file(tmp_path: Path) -> None:
    ...
    with requests_mock.Mocker() as m:
        ...
        biomart_request(transcripts, str(tmp_path / "output.csv"))
